...
public class QbftGetSignerMetrics extends AbstractGetSignerMetricsMethod implements JsonRpcMethod {

  public QbftGetSignerMetrics(
  ...
  public String getName() {
    return RpcMethod.QBFT_GET_SIGNER_METRICS.getMethodName();
  }
}
