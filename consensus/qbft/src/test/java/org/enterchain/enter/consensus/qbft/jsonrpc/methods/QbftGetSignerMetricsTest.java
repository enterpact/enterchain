...
import org.enterchain.enter.ethereum.api.jsonrpc.internal.results.SignerMetricResult;
...
public class QbftGetSignerMetricsTest {
  ...
  public void setup() {
    ...
    method = new QbftGetSignerMetrics(voteTallyCache, blockInterface, blockchainQueries);
  }
