 ...
 */
package org.enterchain.enter.cli.util;
...
import org.enterchain.enter.plugin.services.PluginVersionsProvider;
...
public class VersionProviderTest {
  ...
  public void validateEmptyListGenerateBesuInfoVersionOnly() {
    ...
    assertThat(versionProvider.getVersion()).containsOnly(EnterInfo.version());
  }
  ...
  public void validateVersionListGenerateValidValues() {
    ...
    final VersionProvider versionProvider = new VersionProvider(pluginVersionsProvider);
    assertThat(versionProvider.getVersion()).containsExactly(EnterInfo.version(), "test");
  }
}
