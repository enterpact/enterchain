...
public final class BesuInfoTest {
  ...
  public void versionStringIsEthstatsFriendly() {
    assertThat(org.enterchain.enter.EnterInfo.version())
  ...
  public void noIdentityNodeNameIsEthstatsFriendly() {
    assertThat(org.enterchain.enter.EnterInfo.nodeName(Optional.empty()))
        .matches("[^/]+/v(\\d+\\.\\d+\\.\\d+[^/]*|null)/[^/]+/[^/]+");
  }
  ...
  public void userIdentityNodeNameIsEthstatsFriendly() {
    assertThat(org.enterchain.enter.EnterInfo.nodeName(Optional.of("TestUserIdentity")))
        .matches("[^/]+/[^/]+/v(\\d+\\.\\d+\\.\\d+[^/]*|null)/[^/]+/[^/]+");
  }
}
