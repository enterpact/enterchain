...
import org.enterchain.enter.plugin.data.BlockHeader;
...
public class BesuEventsImpl implements BesuEvents {
  ...
  public long addLogListener(
    ...
    final List<org.enterchain.enter.ethereum.core.Address> besuAddresses =
        addresses.stream()
            .map(org.enterchain.enter.ethereum.core.Address::fromPlugin)
