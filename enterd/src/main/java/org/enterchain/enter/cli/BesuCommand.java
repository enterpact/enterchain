 ...
 */
package org.enterchain.enter.cli;

import static com.google.common.base.Preconditions.checkNotNull;
import static java.nio.charset.StandardCharsets.UTF_8;
import static java.util.Arrays.asList;
import static java.util.Collections.singletonList;
import static org.enterchain.enter.cli.DefaultCommandValues.getDefaultBesuDataPath;
import static org.enterchain.enter.cli.config.NetworkName.MAINNET;
import static org.enterchain.enter.cli.util.CommandLineUtils.DEPENDENCY_WARNING_MSG;
import static org.enterchain.enter.controller.BesuController.DATABASE_PATH;
import static org.enterchain.enter.ethereum.api.graphql.GraphQLConfiguration.DEFAULT_GRAPHQL_HTTP_PORT;
import static org.enterchain.enter.ethereum.api.jsonrpc.JsonRpcConfiguration.DEFAULT_JSON_RPC_PORT;
import static org.enterchain.enter.ethereum.api.jsonrpc.RpcApis.DEFAULT_JSON_RPC_APIS;
import static org.enterchain.enter.ethereum.api.jsonrpc.websocket.WebSocketConfiguration.DEFAULT_WEBSOCKET_PORT;
import static org.enterchain.enter.ethereum.permissioning.GoQuorumPermissioningConfiguration.QIP714_DEFAULT_BLOCK;
...
import static org.enterchain.enter.metrics.prometheus.MetricsConfiguration.DEFAULT_METRICS_PORT;
import static org.enterchain.enter.metrics.prometheus.MetricsConfiguration.DEFAULT_METRICS_PUSH_PORT;
import static org.enterchain.enter.nat.kubernetes.KubernetesNatManager.DEFAULT_BESU_SERVICE_NAME_FILTER;
...
import org.enterchain.enter.cli.converter.MetricCategoryConverter;
import org.enterchain.enter.cli.converter.PercentageConverter;
import org.enterchain.enter.cli.converter.RpcApisConverter;
import org.enterchain.enter.cli.custom.CorsAllowedOriginsProperty;
import org.enterchain.enter.cli.custom.JsonRPCAllowlistHostsProperty;
import org.enterchain.enter.cli.custom.RpcAuthFileValidator;
import org.enterchain.enter.cli.error.BesuExceptionHandler;
import org.enterchain.enter.cli.options.unstable.DataStorageOptions;
import org.enterchain.enter.cli.options.unstable.DnsOptions;
import org.enterchain.enter.cli.options.unstable.EthProtocolOptions;
import org.enterchain.enter.cli.options.unstable.EthstatsOptions;
import org.enterchain.enter.cli.options.unstable.LauncherOptions;
import org.enterchain.enter.cli.options.unstable.MetricsCLIOptions;
import org.enterchain.enter.cli.options.unstable.MiningOptions;
import org.enterchain.enter.cli.options.unstable.NatOptions;
import org.enterchain.enter.cli.options.unstable.NativeLibraryOptions;
import org.enterchain.enter.cli.options.unstable.NetworkingOptions;
import org.enterchain.enter.cli.options.unstable.RPCOptions;
import org.enterchain.enter.cli.options.unstable.SynchronizerOptions;
import org.enterchain.enter.cli.options.unstable.TransactionPoolOptions;
import org.enterchain.enter.cli.presynctasks.PreSynchronizationTaskRunner;
import org.enterchain.enter.cli.presynctasks.PrivateDatabaseMigrationPreSyncTask;
import org.enterchain.enter.cli.subcommands.PasswordSubCommand;
import org.enterchain.enter.cli.subcommands.PublicKeySubCommand;
import org.enterchain.enter.cli.subcommands.RetestethSubCommand;
import org.enterchain.enter.cli.subcommands.blocks.BlocksSubCommand;
import org.enterchain.enter.cli.subcommands.operator.OperatorSubCommand;
import org.enterchain.enter.cli.subcommands.rlp.RLPSubCommand;
import org.enterchain.enter.cli.util.BesuCommandCustomFactory;
import org.enterchain.enter.cli.util.CommandLineUtils;
import org.enterchain.enter.cli.util.ConfigOptionSearchAndRunHandler;
import org.enterchain.enter.cli.util.VersionProvider;
...
import org.enterchain.enter.controller.TargetingGasLimitCalculator;
...
import org.enterchain.enter.crypto.SignatureAlgorithmType;
import org.enterchain.enter.enclave.EnclaveFactory;
import org.enterchain.enter.enclave.GoQuorumEnclave;
import org.enterchain.enter.ethereum.api.ApiConfiguration;
import org.enterchain.enter.ethereum.api.ImmutableApiConfiguration;
...
import org.enterchain.enter.ethereum.api.tls.TlsClientAuthConfiguration;
...
import org.enterchain.enter.ethereum.eth.sync.SyncMode;
...
import org.enterchain.enter.ethereum.mainnet.precompiles.AbstractAltBnPrecompiledContract;
import org.enterchain.enter.ethereum.p2p.config.DiscoveryConfiguration;
import org.enterchain.enter.ethereum.p2p.peers.EnodeDnsConfiguration;
import org.enterchain.enter.ethereum.p2p.peers.EnodeURLImpl;
import org.enterchain.enter.ethereum.p2p.peers.StaticNodesParser;
import org.enterchain.enter.ethereum.permissioning.GoQuorumPermissioningConfiguration;
...
import org.enterchain.enter.ethereum.permissioning.PermissioningConfigurationBuilder;
import org.enterchain.enter.ethereum.permissioning.SmartContractPermissioningConfiguration;
import org.enterchain.enter.ethereum.privacy.storage.keyvalue.PrivacyKeyValueStorageProvider;
...
import org.enterchain.enter.ethereum.worldstate.PrunerConfiguration;
...
import org.enterchain.enter.metrics.MetricCategoryRegistryImpl;
...
import org.enterchain.enter.metrics.StandardMetricCategory;
import org.enterchain.enter.metrics.prometheus.MetricsConfiguration;
import org.enterchain.enter.metrics.vertx.VertxMetricsAdapterFactory;
...
import org.enterchain.enter.plugin.services.PermissioningService;
...
import org.enterchain.enter.plugin.services.metrics.MetricCategoryRegistry;
import org.enterchain.enter.plugin.services.securitymodule.SecurityModule;
...
import org.enterchain.enter.services.kvstore.InMemoryStoragePlugin;
import org.enterchain.enter.util.NetworkUtility;
import org.enterchain.enter.util.PermissioningConfigurationValidator;
import org.enterchain.enter.util.number.Fraction;
import org.enterchain.enter.util.number.Percentage;
import org.enterchain.enter.util.number.PositiveNumber;
...
public class BesuCommand implements DefaultCommandValues, Runnable {
  ...
  public void run() {
    ...
    try {
      ...
      configureNativeLibs();
      logger.info("Starting Besu version: {}", EnterInfo.nodeName(identityString));
