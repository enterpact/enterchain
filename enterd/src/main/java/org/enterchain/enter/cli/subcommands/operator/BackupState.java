...
import org.enterchain.enter.ethereum.api.query.StateBackupService.BackupStatus;
    ...
    try {
      ...
      final StateBackupService backup =
          new StateBackupService(
              EnterInfo.version(), blockchain, backupDir.toPath(), scheduler, worldStateStorage);
