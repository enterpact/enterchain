...
public class PrometheusMetricsSystem implements ObservableMetricsSystem {
  ...
  private final Map<String, LabelledMetric<org.enterchain.enter.plugin.services.metrics.Counter>>
  ...
  @Override
  public LabelledMetric<org.enterchain.enter.plugin.services.metrics.Counter> createLabelledCounter(
