 ...
 */
package org.enterchain.enter.tests.acceptance.dsl.condition.perm;
...
public class WaitForTrueResponse implements Condition {

  private final Transaction<Boolean> transaction;

  WaitForTrueResponse(final Transaction<Boolean> transaction) {
    this.transaction = transaction;
  }

  @Override
  public void verify(final Node node) {
    WaitUtils.waitFor(() -> Assertions.assertThat(node.execute(transaction)).isTrue());
  }
}
