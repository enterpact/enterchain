...
import org.enterchain.enter.tests.acceptance.dsl.node.configuration.privacy.PrivacyNodeFactory;
import org.enterchain.enter.tests.acceptance.dsl.privacy.account.PrivacyAccountResolver;
import org.enterchain.enter.tests.acceptance.dsl.privacy.condition.PrivateContractVerifier;
import org.enterchain.enter.tests.acceptance.dsl.privacy.condition.PrivateTransactionVerifier;
import org.enterchain.enter.tests.acceptance.dsl.privacy.contract.PrivateContractTransactions;
...
public class PrivacyAcceptanceTestBase {
  ...
  public PrivacyAcceptanceTestBase() {
    ...
    priv =
        new PrivConditions(
            new org.enterchain.enter.tests.acceptance.dsl.transaction.privacy
                .PrivacyTransactions());
