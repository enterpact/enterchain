 ...
 */
package org.enterchain.enter.plugin.services.storage.rocksdb.configuration;
...
public class RocksDBConfigurationBuilder {
  ...
  private int maxBackgroundCompactions = RocksDBCLIOptions.DEFAULT_MAX_BACKGROUND_COMPACTIONS;
