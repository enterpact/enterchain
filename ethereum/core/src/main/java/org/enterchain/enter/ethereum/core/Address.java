...
public class Address extends DelegatingBytes implements org.enterchain.enter.plugin.data.Address {
  ...
  public static Address fromPlugin(final org.enterchain.enter.plugin.data.Address logger) {
