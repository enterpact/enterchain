...
public class BlockHeader extends SealableBlockHeader
    implements org.enterchain.enter.plugin.data.BlockHeader {
  ...
  public static org.enterchain.enter.ethereum.core.BlockHeader convertPluginBlockHeader(
      final org.enterchain.enter.plugin.data.BlockHeader pluginBlockHeader,
      final BlockHeaderFunctions blockHeaderFunctions) {
    return new org.enterchain.enter.ethereum.core.BlockHeader(
        ...
        org.enterchain.enter.ethereum.core.Address.fromHexString(
