...
public class Hash extends DelegatingBytes32 implements org.enterchain.enter.plugin.data.Hash {
  ...
  public static Hash fromPlugin(final org.enterchain.enter.plugin.data.Hash blockHash) {
