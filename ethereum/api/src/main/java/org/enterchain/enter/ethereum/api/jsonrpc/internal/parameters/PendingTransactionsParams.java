 ...
 */
package org.enterchain.enter.ethereum.api.jsonrpc.internal.parameters;

import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.PendingTransactionFilter.FROM_FIELD;
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.PendingTransactionFilter.GAS_FIELD;
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.PendingTransactionFilter.GAS_PRICE_FIELD;
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.PendingTransactionFilter.NONCE_FIELD;
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.PendingTransactionFilter.TO_FIELD;
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.PendingTransactionFilter.VALUE_FIELD;
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.Predicate.ACTION;
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.Predicate.EQ;
...
import org.enterchain.enter.ethereum.api.jsonrpc.internal.results.transaction.pool.Predicate;
