...
import static org.enterchain.enter.ethereum.api.jsonrpc.internal.response.JsonRpcError.INVALID_REQUEST;

import org.enterchain.enter.ethereum.api.handlers.HandlerFactory;
import org.enterchain.enter.ethereum.api.handlers.TimeoutOptions;
import org.enterchain.enter.ethereum.api.jsonrpc.authentication.AuthenticationService;
import org.enterchain.enter.ethereum.api.jsonrpc.authentication.AuthenticationUtils;
...
import org.enterchain.enter.ethereum.api.jsonrpc.internal.JsonRpcRequestId;
...
import org.enterchain.enter.ethereum.api.jsonrpc.internal.response.JsonRpcNoResponse;
...
import org.enterchain.enter.nat.core.domain.NatServiceType;
...
import org.enterchain.enter.plugin.services.metrics.OperationTimer;
...
public class JsonRpcHttpService {
  ...
  private JsonRpcHttpService(
    ...
    this.tracer = GlobalOpenTelemetry.getTracer("org.enterchain.enter.jsonrpc", "1.0.0");
