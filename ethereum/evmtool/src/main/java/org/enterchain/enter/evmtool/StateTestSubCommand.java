...
import static org.enterchain.enter.ethereum.referencetests.ReferenceTestProtocolSchedules.shouldClearEmptyAccounts;
import static org.enterchain.enter.evmtool.StateTestSubCommand.COMMAND_NAME;
...
public class StateTestSubCommand implements Runnable {
  ...
  private void traceTestSpecs(final String test, final List<GeneralStateTestCaseEipSpec> specs) {
    Configurator.setLevel(
        "org.enterchain.enter.ethereum.mainnet.ProtocolScheduleBuilder", Level.OFF);
    final var referenceTestProtocolSchedules = ReferenceTestProtocolSchedules.create();
    Configurator.setLevel("org.enterchain.enter.ethereum.mainnet.ProtocolScheduleBuilder", null);
