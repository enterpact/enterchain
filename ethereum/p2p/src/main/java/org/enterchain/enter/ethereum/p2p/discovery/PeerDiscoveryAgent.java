...
import org.enterchain.enter.ethereum.p2p.discovery.internal.PeerDiscoveryController;
import org.enterchain.enter.ethereum.p2p.discovery.internal.PeerDiscoveryController.AsyncExecutor;
import org.enterchain.enter.ethereum.p2p.discovery.internal.PeerRequirement;
import org.enterchain.enter.ethereum.p2p.discovery.internal.PingPacketData;
import org.enterchain.enter.ethereum.p2p.discovery.internal.TimerUtil;
import org.enterchain.enter.ethereum.p2p.peers.EnodeURLImpl;
import org.enterchain.enter.ethereum.p2p.peers.Peer;
import org.enterchain.enter.ethereum.p2p.peers.PeerId;
...
import org.enterchain.enter.plugin.services.storage.KeyValueStorageTransaction;
...
public abstract class PeerDiscoveryAgent {
  ...
  /* This is the {@link org.enterchain.enter.ethereum.p2p.Peer} object representing our local node.
