...
import org.enterchain.enter.ethereum.eth.manager.task.WaitForPeerTask;
import org.enterchain.enter.ethereum.eth.sync.tasks.RetryingGetHeaderFromPeerByNumberTask;
